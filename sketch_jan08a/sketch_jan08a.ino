...
PID_SAMUDRA::PID_SAMUDRA(double Kp, double Ki, double Kd, double Min, double Max)
{
  reset();
  PID_SAMUDRA::SetOutputLimits(Min, Max);
  PID_SAMUDRA::SetTunings(Kp, Ki, Kd);
}



double PID_SAMUDRA::Compute(double input, double zero, double Setpoint)
{
